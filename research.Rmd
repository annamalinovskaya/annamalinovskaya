...
- #### "Long Term Own and Dynamic Complementarity Effects of the WIC Program" ####
  ...
  - _April 11_, Western Economic Association International (WEAI), 17th International Conference

  - _May 16-18_, American Community Survey Data Users Conference, Population Reference Bureau
 
  - _June 28_, U.S. Census Bureau FSRDC Presentation Series
 
  - _July 10_, Knowledge Share Workshop, Social, Economic, and Housing Statistics Division [SEHSD] of the U.S. Census Bureau
  
  - _August 2-3_, Data Intensive Research Conference, a collaboration between IPUMS and the University of Minnesota 
 
- #### "The COVID Pandemic and New Work" ####

  - _July 3-6_, Western Economic Association International (WEAI), 98th Annual Conference
...
#### 2.1 COVID-driven technology adoption and US firm labor demand ####
...
_A more detailed description of this project is available on the Russell Sage Foundation website [here](https://www.russellsage.org/sites/default/files/sample_drg_proposals.pdf)._ 

#### 2.2 The COVID pandemic and new work ####
